...
use crate::commands::system::context_menu::{
    CONTEXT_CALCULATE_SIZE_MENU_ITEM_ID, CONTEXT_COPY_MENU_ITEM_ID, CONTEXT_COPY_PATH_MENU_ITEM_ID,
    CONTEXT_CREATE_ZIP_MENU_ITEM_ID, CONTEXT_DELETE_MENU_ITEM_ID, CONTEXT_EXTRACT_ZIP_MENU_ITEM_ID,
    CONTEXT_INFO_MENU_ITEM_ID, CONTEXT_MOVE_MENU_ITEM_ID, CONTEXT_NEW_FILE_MENU_ITEM_ID,
    CONTEXT_NEW_FOLDER_MENU_ITEM_ID, CONTEXT_NORMALIZE_NFC_MENU_ITEM_ID,
    CONTEXT_REFRESH_MENU_ITEM_ID, CONTEXT_RENAME_MENU_ITEM_ID, CONTEXT_REVEAL_MENU_ITEM_ID,
    CONTEXT_SEARCH_MENU_ITEM_ID, CONTEXT_TERMINAL_MENU_ITEM_ID,
};
...
pub(crate) fn handle_menu_event<R: Runtime>(app: &AppHandle<R>, event_id: &str) {
    match event_id {
        ...
        CONTEXT_CALCULATE_SIZE_MENU_ITEM_ID => {
            let _ = app.emit("context-menu-action", "calculate-size");
        }
