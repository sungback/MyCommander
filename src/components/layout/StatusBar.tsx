      ...
      <div className="border-t border-border-color/80 px-2 py-2">
        <div className="flex flex-wrap items-center gap-2">
          ...
          <div className="ml-auto flex items-center gap-2 text-text-secondary">
            {statusMessage ? (
              <div className="rounded-md border border-border-color bg-bg-panel px-3 py-2 text-sm">
                {statusMessage}
              </div>
            ) : null}
            <button
              onClick={() => useDialogStore.getState().setOpenDialog("settings")}
              className="flex items-center gap-2 px-3 py-2 text-sm rounded bg-bg-panel hover:bg-bg-hover active:opacity-80 transition-colors border border-border-color text-text-secondary hover:text-accent-color focus:outline-none focus:ring-1 focus:ring-accent-color"
              title="Preferences"
            >
